            ...
            >
                {movieDetails.map((details, index) => (
                    <SwiperSlide key={index}>
                        <div className="h-screen bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${details.img})` }}>
                                ...
                                <div className="max-w-full sm:max-w-[90%] md:max-w-[70%] lg:max-w-[60%] xl:max-w-[50%]">
                                    ...
                                    <div className="features mt-3 flex flex-wrap items-center gap-y-3 sm:gap-x-5 text-xs sm:text-sm">
                                        <div className="rate relative flex items-center">
                                            <svg className="circle-chart rotate-[270deg]" viewBox="0 0 30 30" width="30" height="30" fill="transparent" xmlns="http://www.w3.org/2000/svg">
                                                <circle className="circle-chart__background" stroke="#eee" strokeWidth="2" fill="none" cx="15" cy="15" r="14"></circle>
                                                <circle className="circle-chart__circle" stroke="#4eb04b" strokeWidth="2" strokeDasharray="40,100" cx="15" cy="15" r="14"></circle>
                                            </svg>
                                            <b className='absolute top-[6px] left-[9px] text-[10px]'>4.8</b>
                                    ...
                                    <div className="button mt-2">
                                        <button className='py-2 sm:py-3 px-6 sm:px-8 bg-red-600 rounded-xl text-sm sm:text-base hover:bg-red-700'>Discover Now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
